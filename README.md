# Cupcake C# Sample Activities

Canonical sample of how Cupcake activity types are authored in C# (.NET).

One shared `Program.cs` plus YAML definitions for each supported activity type (Learning Contents schemas).
